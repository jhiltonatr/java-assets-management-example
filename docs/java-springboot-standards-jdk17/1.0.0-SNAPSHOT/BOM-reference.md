...
| `com.fasterxml.jackson.core` | `jackson-databind` | `jar` | `-` | `2.17.2` | `CVE-2026-54512` (:red_circle: high)<br>`CVE-2026-54513` (:red_circle: high)<br>`CVE-2026-54514` (:warning: medium)<br>`CVE-2026-54515` (:warning: medium) |
...
| `org.apache.logging.log4j` | `log4j-api` | `jar` | `-` | `2.21.1` | `CVE-2026-34479` (:warning: medium)<br>`CVE-2026-34477` (:warning: medium)<br>`CVE-2026-49844` (:warning: medium) |
...
| `org.apache.tomcat.embed` | `tomcat-embed-core` | `jar` | `-` | `10.1.33` | `CVE-2024-50379` (:triangular_flag_on_post: critical)<br>`CVE-2024-56337` (:triangular_flag_on_post: critical)<br>`CVE-2025-24813` (:triangular_flag_on_post: critical)<br>`CVE-2025-31651` (:triangular_flag_on_post: critical)<br>`CVE-2026-41293` (:triangular_flag_on_post: critical)<br>`CVE-2026-43512` (:triangular_flag_on_post: critical)<br>`CVE-2026-65905` (:triangular_flag_on_post: critical)<br>`CVE-2025-55754` (:triangular_flag_on_post: critical)<br>`CVE-2025-66614` (:triangular_flag_on_post: critical)<br>`CVE-2026-29145` (:triangular_flag_on_post: critical)<br>`CVE-2026-43515` (:triangular_flag_on_post: critical)<br>`CVE-2026-53434` (:triangular_flag_on_post: critical)<br>`CVE-2026-55276` (:triangular_flag_on_post: critical)<br>`CVE-2026-59083` (:triangular_flag_on_post: critical)<br>`CVE-2026-59084` (:triangular_flag_on_post: critical)<br>`CVE-2026-65182` (:triangular_flag_on_post: critical)<br>`CVE-2026-68525` (:triangular_flag_on_post: critical)<br>`CVE-2025-49124` (:red_circle: high)<br>`CVE-2026-65183` (:red_circle: high)<br>`CVE-2026-66422` (:red_circle: high)<br>`CVE-2026-68569` (:red_circle: high)<br>`CVE-2025-31650` (:red_circle: high)<br>`CVE-2025-48988` (:red_circle: high)<br>`CVE-2025-48989` (:red_circle: high)<br>`CVE-2025-49125` (:red_circle: high)<br>`CVE-2025-52520` (:red_circle: high)<br>`CVE-2025-53506` (:red_circle: high)<br>`CVE-2025-55752` (:red_circle: high)<br>`CVE-2026-24734` (:red_circle: high)<br>`CVE-2026-24880` (:red_circle: high)<br>`CVE-2026-29146` (:red_circle: high)<br>`CVE-2026-34483` (:red_circle: high)<br>`CVE-2026-34487` (:red_circle: high)<br>`CVE-2026-41284` (:red_circle: high)<br>`CVE-2026-43513` (:red_circle: high)<br>`CVE-2026-65927` (:red_circle: high)<br>`CVE-2026-68763` (:red_circle: high)<br>`CVE-2025-46701` (:red_circle: high)<br>`CVE-2026-42498` (:red_circle: high)<br>`CVE-2026-53404` (:red_circle: high)<br>`CVE-2026-55957` (:red_circle: high)<br>`CVE-2026-73180` (:warning: medium)<br>`CVE-2025-55668` (:warning: medium)<br>`CVE-2026-34500` (:warning: medium)<br>`CVE-2026-55955` (:warning: medium)<br>`CVE-2026-55956` (:warning: medium)<br>`CVE-2026-25854` (:warning: medium)<br>`CVE-2026-50229` (:warning: medium)<br>`CVE-2024-54677` (:warning: medium)<br>`CVE-2025-61795` (:warning: medium)<br>`CVE-2026-66299` (:warning: medium)<br>`CVE-2026-24733` (:small_blue_diamond: low)<br>`CVE-2026-43514` (:small_blue_diamond: low) |
...
| `org.springframework` | `spring-core` | `jar` | `-` | `6.1.15` | `CVE-2026-41855` (:triangular_flag_on_post: critical)<br>`CVE-2026-47884` (:triangular_flag_on_post: critical)<br>`CVE-2026-47891` (:triangular_flag_on_post: critical)<br>`CVE-2026-47892` (:triangular_flag_on_post: critical)<br>`CVE-2026-59313` (:triangular_flag_on_post: critical)<br>`CVE-2026-59283` (:triangular_flag_on_post: critical)<br>`CVE-2026-41838` (:red_circle: high)<br>`CVE-2026-41842` (:red_circle: high)<br>`CVE-2026-41848` (:red_circle: high)<br>`CVE-2026-41850` (:red_circle: high)<br>`CVE-2026-41851` (:red_circle: high)<br>`CVE-2026-47885` (:red_circle: high)<br>`CVE-2026-47886` (:red_circle: high)<br>`CVE-2026-47888` (:red_circle: high)<br>`CVE-2026-47893` (:red_circle: high)<br>`CVE-2026-59282` (:red_circle: high)<br>`CVE-2026-22740` (:warning: medium)<br>`CVE-2026-41844` (:warning: medium)<br>`CVE-2026-41845` (:warning: medium)<br>`CVE-2026-41846` (:warning: medium)<br>`CVE-2026-47887` (:warning: medium)<br>`CVE-2026-59281` (:warning: medium)<br>`CVE-2026-22737` (:warning: medium)<br>`CVE-2026-41840` (:warning: medium)<br>`CVE-2026-41841` (:warning: medium)<br>`CVE-2026-41843` (:warning: medium)<br>`CVE-2026-22745` (:warning: medium)<br>`CVE-2026-41852` (:warning: medium)<br>`CVE-2026-41853` (:warning: medium)<br>`CVE-2026-59280` (:warning: medium)<br>`CVE-2026-41839` (:warning: medium)<br>`CVE-2026-59314` (:small_blue_diamond: low)<br>`CVE-2026-22741` (:small_blue_diamond: low)<br>`CVE-2026-22735` (:small_blue_diamond: low) |
